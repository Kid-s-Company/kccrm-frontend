...
export const getMainTheme = (mode: ThemeMode) => createTheme({
    palette: {
        mode,
        primary: {
            main: mode === 'light' ? '#ffffff' : '#1C1C1C',
        },
        secondary: {
            main: '#ff9100',
        },
        ...
        text: {
            ...
            nonImportant: mode === 'light' ? 'rgba(28, 28, 28, 0.40)' : 'rgba(255, 255, 255, 0.40)', // Add this line
        },
    },
    components: {
        MuiListItemButton: {
        ...
        // Below are from the login theme
        MuiTypography: {
            styleOverrides: {
